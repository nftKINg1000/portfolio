...
import { Menu, Briefcase, Tag, HelpCircle, FileText, Info, MessageCircle } from "lucide-react"
        ...
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          ...
          <Link href="/" className="flex items-center gap-1.5">
            <Image
              ...
              className="h-5 w-5"
            />
            <span className="font-semibold tracking-wide text-white">Emmanuel O. King</span>
          </Link>
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                ...
                <div className="flex items-center gap-1.5 px-4 py-4 border-b border-gray-800">
                  <Image
                    ...
                    className="h-6 w-6"
                  />
                  <span className="font-semibold tracking-wide text-white text-lg">Emmanuel O. King</span>
                </div>
